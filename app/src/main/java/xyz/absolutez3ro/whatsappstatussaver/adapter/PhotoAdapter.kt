...
class PhotoAdapter(private var photoList: ArrayList<Photo>, private val context: Context) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.saveButton.setOnClickListener { FileHelper.saveItem(context, photo.uri, photo.fileName, photo.mime) }
    }
    ...
    fun setList(photoList: ArrayList<Photo>) {
